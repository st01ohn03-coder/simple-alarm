...
(function () {
  ...
  /* ---------- 注記（景表法・根拠表示） ---------- */
  // 実績や最上級の表現を出すなら、根拠（調査主体・対象・期間）をここに書いて
  // 同じ画面に出す。景品表示法の観点から、注記を消して使い回さないこと。
  var NOTE1 = '※1 ここに根拠を書く（調査主体・対象・期間）';
  var NOTE2 = '※2 ここに根拠を書く（調査主体・対象・期間）';
  var NOTE_SUB = '※ 搭載機能は製品により異なります。他方式との比較は支払い方式の違いを示すもので、金額を表すものではありません。';
  var NOTES = [
    { a: 5.00,  b: 8.40,  text: NOTE1 },
    { a: 30.70, b: 36.00, text: NOTE_SUB },
    { a: 36.80, b: 39.40, text: NOTE1 + '　' + NOTE2 }
  ];
