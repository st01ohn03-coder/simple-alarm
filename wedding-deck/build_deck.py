...
BGM = "bgm_nakamura_ni_narouyo.mp3"
...
def nakamura_slide(prs, audio):
    ...
    add_notes(slide, "\n".join([
        ...
        "入っている音源：カラオケ（歌なし）「家族になろうよ」／約5分9秒。",
        "",
        "曲はこのスライドを表示しているあいだ流れます。次のスライドへ進むと止まります。",
        "そのまま流し続けたい場合は、スピーカーアイコンを選択して",
        "[再生]タブ →[スライド切り替え後も再生] にチェックを入れてください。",
        "",
        "スピーカーアイコンはスライドの左外（グレー部分）に逃がしてあるので、",
        "本番の画面には映りません。",
    ]))
    return slide
